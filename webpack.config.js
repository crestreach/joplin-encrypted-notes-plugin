// -----------------------------------------------------------------------------
// This is the Joplin plugin webpack config (standard template).
// -----------------------------------------------------------------------------
...
function validateCategories(categories) {
	...
	categories.forEach(category => {
		if (!allPossibleCategories.map(c => c.name).includes(category)) throw new Error(`${category} is not a valid category. Valid categories are:\n${allPossibleCategories.map(c => c.name)}\n`);
	});
}
...
function validateScreenshots(screenshots) {
	...
	for (const screenshot of screenshots) {
		...
		if (!allPossibleScreenshotsType.includes(screenshotType)) throw new Error(`${screenshotType} is not a valid screenshot type.`);
